...
public class JSSchedulerInputDialog extends JSInputDialog {
	...
	public JPanel getPanel() {
		if (panel == null) {
			...
			GridBagConstraints labelConstraints = getLabelConstraints(new Insets(0, 0, 2, 5));
			GridBagConstraints textFieldInputConstraints = getTextFieldInputConstraints(new Insets(0, 0, 2, 0));
			GridBagConstraints checkBoxConstraints = getRadioButtonConstraints(new Insets(0, 0, 2, 0));
			panel.add(getRebootLabel(), labelConstraints);
			panel.add(getRebootRadioButton(), checkBoxConstraints);
			panel.add(getYearlyLabel(), labelConstraints);
			panel.add(getYearlyRadioButton(), checkBoxConstraints);
			panel.add(getMonthlyLabel(), labelConstraints);
			panel.add(getMonthlyRadioButton(), checkBoxConstraints);
			panel.add(getWeeklyLabel(), labelConstraints);
			panel.add(getWeeklyRadioButton(), checkBoxConstraints);
			panel.add(getDailyLabel(), labelConstraints);
			panel.add(getDailyRadioButton(), checkBoxConstraints);
			panel.add(getHourlyLabel(), labelConstraints);
			panel.add(getHourlyRadioButton(), checkBoxConstraints);
			panel.add(getCustomizeLabel(), labelConstraints);
			panel.add(getCustomizeRadioButton(), checkBoxConstraints);
			...
			panel.add(new JScrollPane(getCommandTextArea()), getTextAreaConstraints());
		}
		return panel;
	}
