...
import jsuis.JSPopupMenu;
import jsuis.JSTable;
import jsuis.util.JSI18n;
import scheduler.JSScheduler;
import scheduler.controller.JSSchedulerAddAction;
import scheduler.controller.JSSchedulerDirectoryAction;
import scheduler.controller.JSSchedulerDownAction;
import scheduler.controller.JSSchedulerEditAction;
import scheduler.controller.JSSchedulerRemoveAction;
import scheduler.controller.JSSchedulerRunAction;
import scheduler.controller.JSSchedulerSaveAction;
import scheduler.controller.JSSchedulerTableModelListener;
import scheduler.controller.JSSchedulerTableShowNextDatesAction;
import scheduler.controller.JSSchedulerUpAction;
...
public class JSSchedulerFrame extends JFrame {
	...
	public JSSchedulerFrame() {
		setTitle("e-Agendamento");
		setIconImage(((ImageIcon) JSI18n.getIcon(JSScheduler.class, JSScheduler.class.getSimpleName() + ".png")).getImage());
