...
@Controller
public class JSProgressBarExampleController {
	...
	@RequestMapping("/examples/jsprogressbar")
	public void jsprogressbarexample(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/jsp/examples/jsprogressbar.jsp").forward(request, response);
	}
}
