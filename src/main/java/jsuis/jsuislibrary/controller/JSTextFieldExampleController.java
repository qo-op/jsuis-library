...
@Controller
public class JSTextFieldExampleController {
	...
	@RequestMapping("/examples/jstextfield")
	public void jstextfieldexample(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/jsp/examples/jstextfield.jsp").forward(request, response);
	}
}
