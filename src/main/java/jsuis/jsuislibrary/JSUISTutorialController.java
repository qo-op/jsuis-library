...
@Controller
public class JSUISTutorialController {
	...
	// @RequestMapping("/tutorials/jsuis")
	@RequestMapping("/")
	public void jsuistutorial(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("title", "How to use JSUIS");
		request.setAttribute("clazz", "jstutorial.JSFrame_JSUISTutorial");
		request.setAttribute("args", args);
		
		request.getRequestDispatcher("/jsp/tutorials/jsuis.jsp").forward(request, response);
	}
}
