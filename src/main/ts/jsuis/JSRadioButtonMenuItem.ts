...
/**
 * JSRadioButtonMenuItem
 * 
 * @author Yassuo Toda
 */
class JSRadioButtonMenuItem extends JSMenuItem {
    
    private div_Content: JSDiv;
    private div_Glass: JSDiv;
    private span_Input: JSSpan;
    private radioButton: JSRadioButtonInput;
    private mouseListener_RadioButtonMenuItem: JSMouseListener;
    ...
    constructor() {
        ...
        this.setUI(JSRadioButtonMenuItemUI.getInstance());
    ...
    getInput(): JSComponent {
        if (!this.radioButton) {
            this.radioButton = new JSRadioButtonInput();
        }
    ...
    getMouseListener(): JSMouseListener {
        if (!this.mouseListener_RadioButtonMenuItem) {
            this.mouseListener_RadioButtonMenuItem = new JSRadioButtonMenuItemMouseListener(this);
        }
        return this.mouseListener_RadioButtonMenuItem;
    }
}
