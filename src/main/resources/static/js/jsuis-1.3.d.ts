...
declare class JSProperties {
    ...
    load(properties: JSProperties): void;
}
...
declare class JSBodyFrameContainer extends JSPanel {
    constructor();
    constructor(element: HTMLElement);
}
...
declare class JSTreeCellLabelText extends JSHTMLComponent {
    constructor();
    constructor(element: HTMLElement);
}
